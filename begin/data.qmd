...
![The booksales.csv data file. On the left, I've opened the file in using a spreadsheet program (OpenOffice), which shows that the file is basically a table. On the right, the same file is open in a standard text editor (the TextEdit program on a Mac), which shows how the file is formatted. The entries in the table are wrapped in quote marks and separated by commas.]("images/mechanics/booksalescsv.jpg"){width=2.5in}
...
![The RStudio window for importing a CSV file into R.]("images/rstudio_screenshots/import.png"){width=2.5in}
