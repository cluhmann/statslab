...
First time users often confuse R and RStudio. At its simplest, R is like a car's engine while RStudio is like a car's dashboard as illustrated in Figure @fig-R-vs-RStudio-1.
...
### Package Installation {sec-packageinstallation}
...
`...` it means that you didn't successfully install it. If you get this error message, go back to Subsection @sec-packageinstallation on R package installation and make sure to install the `ggplot2` package before proceeding.
