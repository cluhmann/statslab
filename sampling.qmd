...
Instead of performing an exhaustive count, let's insert a shovel into the bowl as seen in @fig-sampling-exercise-2. Using the shovel, let's remove $5 \cdot 10 = 50$ balls, as seen in Figure @fig-sampling-exercise-3.
...
To help reinforce these concepts, let's re-display @fig-comparing-sampling-distributions but using our new terminology, notation, and definitions relating to sampling in Figure @fig-comparing-sampling-distributions-2.
